...
Public Class FrmSelectCmbCheck
    Dim CmbBox As Telerik.WinControls.UI.RadCheckedDropDownList
    Dim Dialog As UserControls.ClsDialog
    Public Sub New(Cmb As Telerik.WinControls.UI.RadCheckedDropDownList)
        Me.CmbBox = Cmb
        InitializeComponent()
        ...
        If CmbBox.CheckedMember <> "" Then
            Me.Grd.Columns(CmbBox.CheckedMember).IsVisible = True
            Me.Grd.Columns(CmbBox.CheckedMember).HeaderText = "✓"
        End If
    End Sub
