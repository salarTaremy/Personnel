...
Public Class ClsTools
    ...
    ''' <remarks></remarks>
    Public Sub Grd_SetPivotHeaderText(Grd As Telerik.WinControls.UI.RadGridView, TblName As String, Optional FieldName As String = "PropertyName", Optional FormatString As String = Nothing, Optional TextAlignment As System.Drawing.ContentAlignment = ContentAlignment.MiddleCenter)
        ...
        Next
    End Sub
    Public Function NumberToString(ByRef x As String) As String
        ...
        Select Case Len(inp)
            ...
            Case 4
                If Int(CDbl(Strings.Right(inp, 3))) > 0 Then RetVal = " و " & _
    ...
    End Function
    Public Sub SelectCmb(Cmb As Telerik.WinControls.UI.RadDropDownList)
        Dim Frm As New FrmSelectCmb(Cmb)
        Frm.Show()
    End Sub
