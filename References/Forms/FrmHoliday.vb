Public Class FrmHoliday
    ...
    Private Sub FillGrid()
        Try
            With Me.Grd
                .DataSource = Clander.GetHoliDay(SalMali)
    ...
    Private Sub BtnSave_Click(sender As Object, e As EventArgs) Handles BtnSave.Click
        Try
            If Dialog.ShowQuestion("برای ذخیره مطمئن هستید ؟؟") = False Then
                Exit Sub
            End If
            If Clander.UpdateHoliDay(SalMali, Me.Grd.DataSource) > 0 Then
    ...
    Private Sub BtnAdd_Click(sender As Object, e As EventArgs) Handles BtnAdd.Click
        Try
            If Mid(Me.UcDate.txt, 1, 4) <> SalMali Then
