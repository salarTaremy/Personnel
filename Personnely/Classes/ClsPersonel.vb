...
Public Class ClsPersonel
    ...
    Public Function GetAll() As DataTable
        Try
            Dim cmd As New SqlClient.SqlCommand
            With cmd
                .CommandText = "[Pr].[UspGetPersonList]"
                .CommandType = CommandType.StoredProcedure
            End With
            Return DB.FillDataTable(cmd)
        ...
        End Try
    End Function
    Public Function GetAll(ID_Person As Long) As DataTable
        Try
            Dim cmd As New SqlClient.SqlCommand
            With cmd
                .CommandText = "[Pr].[UspGetPersonList]"
                .Parameters.AddWithValue("@ID_Person", ID_Person)
                .CommandType = CommandType.StoredProcedure
            End With
            Return DB.FillDataTable(cmd)
        Catch ex As Exception
        ...
        End Try
    End Function
    Public Function GetAllPerKargah() As DataTable
        Try
            Dim cmd As New SqlClient.SqlCommand
            With cmd
                .CommandText = "[Pr].[UspGetPersonListPerKargah]"
                .CommandType = CommandType.StoredProcedure
            End With
            Return DB.FillDataTable(cmd)
        Catch ex As Exception
        ...
        End Try
    End Function
    Public Function GetAllPerKargah(ID_Kargah As Long) As DataTable
        Try
            Dim cmd As New SqlClient.SqlCommand
            With cmd
                .CommandText = "[Pr].[UspGetPersonListPerKargah]"
                .Parameters.AddWithValue("@ID_Kargah", ID_Kargah)
                .CommandType = CommandType.StoredProcedure
            End With
            Return DB.FillDataTable(cmd)
        Catch ex As Exception
        ...
        End Try
    End Function
    Public Function GetAllPerKargah(ID_Kargah As Long, ID_Person As Long) As DataTable
        Try
            Dim cmd As New SqlClient.SqlCommand
            With cmd
                .CommandText = "[Pr].[UspGetPersonListPerKargah]"
    ...
    Public Class Propertes
        ...
        Public Function Update() As Boolean
            ...
            End If
        End Function
        Public Function GetAllWithValue() As DataTable
            Try
                Dim cmd As New SqlClient.SqlCommand
                cmd.CommandText = "[Pr].[UspGetAllPropertyWithValue]"
                cmd.CommandType = CommandType.StoredProcedure
                Return DB.FillDataTable(cmd)
            Catch ex As Exception
                Throw ex
            End Try
        End Function
        Public Function GetAllWithValue(ID_Property As Long) As DataTable
            Try
                Dim cmd As New SqlClient.SqlCommand
                cmd.CommandText = "[Pr].[UspGetAllPropertyWithValue]"
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.AddWithValue("ID_Property", ID_Property)
                Return DB.FillDataTable(cmd)
            Catch ex As Exception
                Throw ex
            End Try
