Public Class FrmAvamelHokmi
    ...
    Private Sub CmbType_SelectedIndexChanged(sender As Object, e As Telerik.WinControls.UI.Data.PositionChangedEventArgs) Handles CmbType.SelectedIndexChanged
        If Me.CmbType.SelectedValue = 2 Then
            Me.ChkBime.Enabled = False
            Me.ChkTax.Enabled = False
        Else
            Me.ChkBime.Enabled = True
            Me.ChkTax.Enabled = True
        End If
    End Sub
End Class