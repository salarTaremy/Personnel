...
Public Class FrmKarmand
    ...
    Private Sub BtnBrows_Click(sender As Object, e As EventArgs) Handles BtnBrows.Click
        th = New TarafHesab.ClsTarafHesab
    ...
    Private Sub BtnSave_Click(sender As Object, e As EventArgs) Handles BtnSave.Click
        ...
        Catch ex As Exception
            Dialog.ShowErorr("خطا در ذخیره اطلاعات کارمند", ex.Message)
        End Try
    End Sub
    Private Function validData() As Boolean
        ...
        End If
        If Me.Mode = My_Mode.AddNew Then
            Dim PrTmp As New ClsPersonel(Me.TxtCodePr.Text.Trim)
            If PrTmp.Exists Then
                Dialog.ShowInfo(String.Format("کد پرسنی وارد شده تکراری است " & vbCrLf & "این کد قبلا به' {0} {1} 'اختصاص داده شده است", PrTmp.Name, PrTmp.Famil))
                Return False
            End If
        End If
        Return True
