Public Class FrmDefaultHokmRls
    ...
    Private Sub FillGrid()
        ...
        Dim ColumnCmb As New Telerik.WinControls.UI.GridViewComboBoxColumn
        With ColumnCmb
            .ValueMember = "ID"
            .DisplayMember = "Name"
        ...
        With Me.Grd
            ...
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            .Columns.Remove(.Columns("Year").Name)
            .Columns.Insert(1, ColumnCmb)
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            .Columns("ID").Width = 35
            .Columns("Year").Width = 95
            .Columns("BasicSalaryPerMonthRls").Width = 125
            .Columns("ZaribEzafeKar").Width = 105
            .Columns("ZaribKasreKar").Width = 80
            .Columns("MaximumChild").Width = 110
            .Columns("BonKargari").Width = 90
            .Columns("HaghMaskan").Width = 100
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            .Columns.Remove(.Columns("Year").Name)
            .Columns.Insert(1, ColumnCmb)
        End With
