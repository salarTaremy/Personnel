...
{
    public partial class FrmLeaveType : Permission.ClsMyForms
    {
        ...
        private void FillGrid()
        {
            try
            {
                this.Grd.DataSource = Le.GetAllTypes();
        ...
        private void BtnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int RowAffect = Le.AddLeaveType(TxtName.Text.Trim());
                if (RowAffect > 0)
                {
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            try
            {
                int RowAffect = Le.UpdateLeaveType  ((DataTable)this.Grd.DataSource);
                if (RowAffect > 0)
                {
